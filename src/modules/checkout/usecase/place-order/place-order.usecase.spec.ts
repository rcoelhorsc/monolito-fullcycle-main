...
describe("PlaceOrderUseCase unit test", () => {
    ...
    describe("valideProducts method", () => {
        ...
        it("should throw error if no product are selectec", async () => {
    ...
    describe("getProducts method", () => {
        ...
        it("should throw return a product", async () => {
            const mockCatalogFacade = {
        ...
        describe("place an order", () => {        
            ...
            const products = {
                ...
                "2": new Product({
                    id: new Id("2"),
                    name: "Prodcut 2",
                    description: "Prodcut 2 description",
                    salesPrice: 20,
                }),                
            };
            ...
            it("should not be approved", async () => {
                mockPaymentFacade.procces = mockPaymentFacade.procces.mockReturnValue({
                    transactionId: "1t",
                    orderId: "1o",
                    amount: 100,
                    status: "error",
                ...
                expect(mockPaymentFacade.procces).toHaveBeenCalledTimes(1);
                expect(mockPaymentFacade.procces).toHaveBeenCalledWith({
                    orderId: output.id,
                    amount: output.total,
                });
